...
import { ArrowRight, RefreshCw, BrainCircuit, Lightbulb, Award, Pencil,ArrowLeft, Hourglass, FastForward } from "lucide-react"; 
       ...
       <SlowMode setStarted={setStarted} started={started} />
          ...
          <div className="flex flex-col items-center justify-center p-10 text-center">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
              <div className="bg-white dark:bg-gray-800/60 backdrop-blur-3xl p-6 rounded-xl shadow-md hover:shadow-lg transition-all border-2 border-gray-200 dark:border-gray-700">
