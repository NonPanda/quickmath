  ...
  const predictAndCheck = async () => {
    ...
    return (
      ...
      <div className="min-h-screen pt-12">
        <div className="max-w-2xl mx-auto bg-[#FAFAF8] dark:bg-gradient-to-t dark:from-gray-900 dark:via-gray-950/90 dark:to-gray-950 rounded-3xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
          ...
          <div className="pb-4 px-24 flex flex-col gap-4">
            <div className="text-4xl md:text-6xl font-bold text-ptext text-center py-4">
              {problem.question}
            </div>
            
            <div className="bg-gray-200 dark:bg-[#1F1F2E] rounded-t-xl overflow-hidden flex flex-col border border-gray-200 dark:border-gray-800" style={{ minHeight: '385px' }}> 
